...
namespace EYE
{
    ...
    public sealed partial class PatientList : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
          ...
          ObservableCollection<Patient> patientList = await webService.getPatientListAsync(fp.familyID);
              this.defaultViewModel["Items"] = patientList;
        ...
        {
            var a = e.ClickedItem as Patient;
            this.Frame.Navigate(typeof(PatientHome),a);
        }
        ...
        {
            this.Frame.Navigate(typeof(PatientRegistration),fp);
        }
